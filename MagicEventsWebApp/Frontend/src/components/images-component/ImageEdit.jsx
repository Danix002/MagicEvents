...
const ImageEdit = ({src, alt, onEditClick}) => {
  ...
  return (
    <div className="relative w-full max-h-[48rem] min-h-21 rounded-md overflow-hidden border border-[#E4DCEF] ring ring-[#E4DCEF] ring-offset-2 flex items-center justify-center">
        {isValid ? (
            <img
